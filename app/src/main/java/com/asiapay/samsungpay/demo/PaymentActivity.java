...
import com.asiapay.sdk.enums.PaySdkEnum;
...
import static com.asiapay.samsungpay.demo.PaySdkConstants.THREE_DS;
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_directcall:
                ...
                if (validatePayData() && validateCardDetaiils()) {
                    ...
                    payData = new PayData();
                    paySDK.setPayConfig(PaymentActivity.this,payData,textMerchantId.getEditText().getText().toString(),selectedEnvType,selectedPayGate);
                    paySDK.setPayData(textAmount.getEditText().getText().toString(),selectedCurrency,EnvBase.PayType.NORMAL_PAYMENT,textOrderRef.getEditText().getText().toString(),"VISA",EnvBase.PayChannel.DIRECT, EnvBase.Language.ENGLISH,"");
                   // paySDK.setCardDetails(textCardNo.getEditText().getText().toString(),textExpiryMonth.getEditText().getText().toString(),textExpiryYear.getEditText().getText().toString(),textSecurityCode.getEditText().getText().toString(),textCardHolderName.getEditText().getText().toString());

                    //Set Card Details
                    final CardDetails cardDetail = new CardDetails();
                    cardDetail.setCardNo(textCardNo.getEditText().getText().toString());
                    cardDetail.setEpMonth(textExpiryMonth.getEditText().getText().toString());
                    cardDetail.setEpYear(textExpiryYear.getEditText().getText().toString());
                    cardDetail.setSecurityCode(textSecurityCode.getEditText().getText().toString());
                    cardDetail.setCardHolder(textCardHolderName.getEditText().getText().toString());
                    payData.setCardDetails(cardDetail);
            ...
            case R.id.btn_new_member:
                ...
                if (validatePayData() && validateCardDetaiils()) {
                    ...
                    paySDK.setPayConfig(PaymentActivity.this,payData,textMerchantId.getEditText().getText().toString(),selectedEnvType,selectedPayGate);
                    paySDK.setPayData(textAmount.getEditText().getText().toString(),selectedCurrency,EnvBase.PayType.NORMAL_PAYMENT,textOrderRef.getEditText().getText().toString(),"VISA",EnvBase.PayChannel.WEBVIEW, EnvBase.Language.ENGLISH,"");
            ...
            case R.id.btn_old_member:
                ...
                if (validatePayData() && PaySdkUtils.hasText(textSecurityCode)) {  //For old member security code is required
                    ...
                    paySDK.setPayConfig(PaymentActivity.this,payData,textMerchantId.getEditText().getText().toString(),selectedEnvType,selectedPayGate);
                    paySDK.setPayData(textAmount.getEditText().getText().toString(),selectedCurrency,EnvBase.PayType.NORMAL_PAYMENT,textOrderRef.getEditText().getText().toString(),"CC",EnvBase.PayChannel.WEBVIEW, EnvBase.Language.ENGLISH,"");
            ...
            case R.id.btn_threeds:
                ...
                if (validatePayData() && validateCardDetaiils()) {
                    ...
                    paySDK.setPayConfig(PaymentActivity.this,payData,textMerchantId.getEditText().getText().toString(),selectedEnvType,selectedPayGate);
                    paySDK.setPayData(textAmount.getEditText().getText().toString(),selectedCurrency,EnvBase.PayType.NORMAL_PAYMENT,textOrderRef.getEditText().getText().toString(),"3DSSDK",EnvBase.PayChannel.DIRECT, EnvBase.Language.ENGLISH,"");
...
//                    startActivityForResult(intent, PAY_CODE);
            ...
            case R.id.btn_payme:
                if (validatePayData()) {
                    ...
                    paySDK.setPayConfig(PaymentActivity.this,payData,textMerchantId.getEditText().getText().toString(),selectedEnvType,selectedPayGate);
                    paySDK.setPayData(textAmount.getEditText().getText().toString(),selectedCurrency,EnvBase.PayType.NORMAL_PAYMENT,textOrderRef.getEditText().getText().toString(),"PayMe",EnvBase.PayChannel.DIRECT, EnvBase.Language.ENGLISH,"");
                    paySDK.setCallBackUrls("mcd://www.apin.com/succ","mcd://www.apin.com/cancel","mcd://www.apin.com/fail","mcd://www.apin.com/fail");
            ...
            case R.id.btn_google_pay:
                ...
                paySDK.setPayConfig(PaymentActivity.this,payData,textMerchantId.getEditText().getText().toString(),selectedEnvType,selectedPayGate);
                paySDK.setPayData(textAmount.getEditText().getText().toString(),selectedCurrency,EnvBase.PayType.NORMAL_PAYMENT,textOrderRef.getEditText().getText().toString(),"GOOGLE",EnvBase.PayChannel.DIRECT, EnvBase.Language.ENGLISH,"");
            ...
            case R.id.btn_alipay:
                ...
                payData = new PayData();
                paySDK.setPayConfig(PaymentActivity.this,payData,textMerchantId.getEditText().getText().toString(),EnvBase.EnvType.SANDBOX,EnvBase.PayGate.PAYDOLLAR);
                paySDK.setPayData(textAmount.getEditText().getText().toString(),EnvBase.Currency.HKD,EnvBase.PayType.NORMAL_PAYMENT,getOrderRef(),"ALIPAYAPP",EnvBase.PayChannel.DIRECT, EnvBase.Language.ENGLISH,"");
            ...
            case R.id.btn_wechat:
                payData = new PayData();
                paySDK.setPayConfig(PaymentActivity.this,payData,textMerchantId.getEditText().getText().toString(),selectedEnvType,selectedPayGate);
                paySDK.setPayData(textAmount.getEditText().getText().toString(),selectedCurrency,EnvBase.PayType.NORMAL_PAYMENT,getOrderRef(),"WECHATAPP",EnvBase.PayChannel.DIRECT, EnvBase.Language.ENGLISH,"");
            ...
            case R.id.btn_octopus:
                ...
                payData = new PayData();
                paySDK.setPayConfig(PaymentActivity.this,payData,textMerchantId.getEditText().getText().toString(),selectedEnvType,selectedPayGate);
                paySDK.setPayData(textAmount.getEditText().getText().toString(),selectedCurrency,EnvBase.PayType.NORMAL_PAYMENT,getOrderRef(),"OCTOPUS",EnvBase.PayChannel.DIRECT, EnvBase.Language.ENGLISH,"");
            ...
            case R.id.btn_alipayhk:
                ...
                paySDK.setPayConfig(PaymentActivity.this,payData,textMerchantId.getEditText().getText().toString(),selectedEnvType,selectedPayGate);
                paySDK.setPayData(textAmount.getEditText().getText().toString(),selectedCurrency,EnvBase.PayType.NORMAL_PAYMENT,getOrderRef(),"ALIPAYHKAPP",EnvBase.PayChannel.DIRECT, EnvBase.Language.ENGLISH,"");
