package com.asiapay.samsungpay.demo.expandableview;
...
import com.asiapay.samsungpay.demo.R;
...
public class ExpandableRelativeLayout extends RelativeLayout implements ExpandableLayout {
    ...
    public void setCalculatedSize(boolean calculatedSize) {
        isCalculatedSize = calculatedSize;
    }
